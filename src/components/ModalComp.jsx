...
const ModalComp = ({ data, setData, dataEdit, isOpen, onClose }) => {
  ...
  const [apartmentNumber, setApartmentNumber] = useState(dataEdit.apartmentNumber || "");
  ...
  const [parkingSpotNumber, setParkingSpotNumber] = useState(dataEdit.parkingSpotNumber || "");

  const toast = useToast();

  const handleSave = () => {
    if (!vehiclePlate || !ownerName || !apartmentNumber || !block || !vehicleModel || !vehicleColor || !parkingSpotNumber) {
      return;
    }
